...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yo(e,t,n){let r=new Float32Array(io),i=new W(0,1,0);return new Wi({name:`SphericalGaussianBlur`,defines:{n:io,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:So(),fragmentShader:`
	...
	`}var Co=class extends Yt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new Di([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`;function xl(){let e=(0,_.useRef)(null),t=(0,_.useRef)({}),n=gl(),r=(0,_.useRef)({currentDoy:n,currentDecl:pl(n),targetDecl:pl(n),rotY:0,velY:0,isDragging:!1,prevX:0,autoPlay:!1,animDoy:n}),i=(0,_.useRef)(null),[a,o]=(0,_.useState)(n),[s,c]=(0,_.useState)(!1),[l,u]=(0,_.useState)({msg:``,visible:!1}),d=(0,_.useRef)(null),{month:f,day:p}=ml(a),m=pl(a),h=hl(a),g=m>=0?`+`:``;function v(e){clearTimeout(d.current),u({msg:e,visible:!0}),d.current=setTimeout(()=>u(e=>({...e,visible:!1})),2600)}let b=(0,_.useCallback)((e,t=!1)=>{let n=Math.max(0,Math.min(364,Math.round(e)));r.current.currentDoy=n,r.current.targetDecl=pl(n),o(n);let i=hl(n);t&&i&&v(`☀ `+i.name)},[]);(0,_.useEffect)(()=>{let n=e.current,a=n.clientWidth,s=n.clientHeight,c=new ol({antialias:!0});c.setPixelRatio(Math.min(window.devicePixelRatio,2)),c.setSize(a,s),c.toneMapping=4,c.toneMappingExposure=1.1,n.appendChild(c.domElement);let l=new Sa(45,a/s,.1,1e3);l.position.set(0,1.5,3.8),l.lookAt(0,0,0);let u=new In,d=8e3,f=new Float32Array(d*3);for(let e=0;e<d;e++){let t=300+Math.random()*100,n=Math.random()*Math.PI*2,r=Math.acos(2*Math.random()-1);f[e*3]=t*Math.sin(r)*Math.cos(n),f[e*3+1]=t*Math.sin(r)*Math.sin(n),f[e*3+2]=t*Math.cos(r)}let p=new Ar;p.setAttribute(`position`,new hr(f,3));let m=new Ei(p,new xi({color:16777215,size:.5,sizeAttenuation:!0,transparent:!0,opacity:.85}));u.add(m);let h=new Dn;h.rotation.z=sl,u.add(h);let g=new Dn;h.add(g);let _=new Wi({uniforms:{dayTexture:{value:_l()},nightTexture:{value:vl()},sunDirection:{value:new W(1,0,0)}},vertexShader:yl,fragmentShader:bl}),v=new $r(new Ii(1,128,128),_);g.add(v);let y=(e,t)=>{let n=e*Math.PI/180,r=[];for(let e=0;e<=256;e++){let t=e/256*Math.PI*2;r.push(new W(1.003*Math.cos(n)*Math.cos(t),1.003*Math.sin(n),1.003*Math.cos(n)*Math.sin(t)))}return new yi(new Ar().setFromPoints(r),new di({color:t,transparent:!0,opacity:.9}))};g.add(y(23.5,16724804)),g.add(y(0,16769126)),g.add(y(-23.5,4500223)),h.add(new yi(new Ar().setFromPoints([new W(0,-1.6,0),new W(0,1.6,0)]),new di({color:4478310,transparent:!0,opacity:.35})));let b=new Dn;b.position.set(5,0,0),u.add(b);let x=[{size:.6,color:16777215,opacity:1},{size:.85,color:16772744,opacity:.55},{size:1.2,color:16763972,opacity:.28},{size:1.75,color:16750848,opacity:.12},{size:2.5,color:16737792,opacity:.06}];x.forEach(({size:e,color:t,opacity:n})=>{b.add(new $r(new Ii(e,32,32),new Vr({color:t,transparent:!0,opacity:n,blending:2,depthWrite:!1})))});let S=new Ta(16775400,2.5);S.position.copy(b.position),u.add(S),u.add(new Ea(1120296,1));let C=new Dn;h.add(C);let w=new Vr({color:16766720,transparent:!0,opacity:.9,side:2,blending:2,depthWrite:!1}),T=new $r(new Fi(.03,.055,48),w);C.add(T),C.add(new $r(new Ni(.018,32),new Vr({color:16777215,transparent:!0,opacity:1,side:2,blending:2})));let E=new Vr({color:16755200,transparent:!0,opacity:.3,side:2,blending:2,depthWrite:!1}),D=new $r(new Fi(.06,.12,48),E);C.add(D),t.current={renderer:c,scene:u,camera:l,earthGroup:h,spinGroup:g,sunGroup:b,sunLayers:x,earthMat:_,subSolarGroup:C,ringMesh:T,ringMat:w,glowMat:E};let O=new Ua,k=0;function A(e){let t=e*Math.PI/180,n=1.003;C.position.set(n*Math.cos(t),n*Math.sin(t),0),C.lookAt(0,0,0),C.rotateX(Math.PI/2),_.uniforms.sunDirection.value.set(Math.cos(t),Math.sin(t),0)}function j(){i.current=requestAnimationFrame(j);let e=O.getDelta(),t=O.getElapsedTime(),n=r.current;if(n.autoPlay){n.animDoy=(n.animDoy+e*18)%365;let t=Math.round(n.animDoy);t!==n.currentDoy&&(n.currentDoy=t,n.targetDecl=pl(t),o(t))}n.currentDecl+=(n.targetDecl-n.currentDecl)*Math.min(e*3.5,1),A(n.currentDecl),n.isDragging||(n.velY*=.94,n.rotY+=n.velY),g.rotation.y=n.rotY,k+=e*2;let a=.88+.12*Math.sin(k);T.scale.setScalar(a),w.opacity=.65+.3*Math.sin(k*1.2),E.opacity=.15+.15*Math.sin(k*.8),b.children.forEach((e,n)=>{n>0&&(e.material.opacity=x[n].opacity*(.92+.08*Math.sin(t*1.5+n*1.3)))}),m.rotation.y=t*.002,c.render(u,l)}j();let ee=()=>{let e=n.clientWidth,t=n.clientHeight;c.setSize(e,t),l.aspect=e/t,l.updateProjectionMatrix()};window.addEventListener(`resize`,ee);let te=e=>e.touches?e.touches[0].clientX:e.clientX,M=e=>{r.current.isDragging=!0,r.current.prevX=te(e),r.current.velY=0},ne=e=>{if(!r.current.isDragging)return;let t=te(e)-r.current.prevX;r.current.rotY+=t*.005,r.current.velY=t*.005,r.current.prevX=te(e)},N=()=>{r.current.isDragging=!1};return c.domElement.addEventListener(`mousedown`,M),c.domElement.addEventListener(`touchstart`,M,{passive:!0}),window.addEventListener(`mousemove`,ne),window.addEventListener(`touchmove`,ne,{passive:!0}),window.addEventListener(`mouseup`,N),window.addEventListener(`touchend`,N),()=>{cancelAnimationFrame(i.current),window.removeEventListener(`resize`,ee),window.removeEventListener(`mousemove`,ne),window.removeEventListener(`touchmove`,ne),window.removeEventListener(`mouseup`,N),window.removeEventListener(`touchend`,N),c.dispose(),n.removeChild(c.domElement)}},[]),(0,_.useEffect)(()=>{r.current.autoPlay=s,s&&(r.current.animDoy=r.current.currentDoy)},[s]);let x=e=>{c(!1),b(parseInt(e.target.value),!0)},S=e=>{let[,t,n]=e.target.value.split(`-`).map(Number);!t||!n||b(fl(t,n),!0)},C=()=>{let e=gl();b(e);let{month:t,day:n}=ml(e);v(`📅 Bugün: ${n} ${cl[t-1]}`)},w=()=>{c(e=>(v(e?`⏸ Durduruldu`:`▶ Oto Oynat Aktif`),!e))},T=m>20?`#ff4455`:m>0?`#ff8866`:m<-20?`#44aaff`:m<0?`#88aaff`:`#ffe066`;return(0,y.jsxs)(`div`,{style:{position:`fixed`,inset:0,background:`#020408`,fontFamily:`'Exo 2', sans-serif`,color:`#c8e0ff`,overflow:`hidden`},children:[(0,y.jsx)(`link`,{rel:`preconnect`,href:`https://fonts.googleapis.com`}),(0,y.jsx)(`link`,{href:`https://fonts.googleapis.com/css2?family=Orbitron:wght@400;700;900&family=Exo+2:wght@300;400;600&display=swap`,rel:`stylesheet`}),(0,y.jsx)(`div`,{ref:e,style:{position:`absolute`,inset:0,zIndex:0}}),(0,y.jsx)(`div`,{style:{position:`fixed`,top:80,left:`50%`,transform:`translateX(-50%)`,zIndex:30,background:`rgba(255,215,0,0.12)`,border:`1px solid rgba(255,215,0,0.5)`,borderRadius:10,padding:`10px 22px`,fontSize:12,letterSpacing:1,color:`#ffd700`,textAlign:`center`,pointerEvents:`none`,fontFamily:`'Orbitron',monospace`,transition:`opacity 0.5s`,opacity:l.visible?1:0},children:l.msg}),(0,y.jsxs)(`div`,{style:{position:`fixed`,top:0,left:0,right:0,zIndex:20,display:`flex`,alignItems:`center`,justifyContent:`space-between`,padding:`14px 28px`,background:`linear-gradient(180deg,rgba(2,4,8,0.95) 0%,rgba(2,4,8,0) 100%)`,borderBottom:`1px solid rgba(80,160,255,0.2)`,backdropFilter:`blur(4px)`},children:[(0,y.jsx)(`div`,{style:{fontFamily:`'Orbitron',monospace`,fontSize:12,fontWeight:700,letterSpacing:3,color:`#44aaff`,opacity:.8},children:`☀ GÜNEŞ SİMÜLASYONU`}),(0,y.jsxs)(`div`,{style:{textAlign:`center`},children:[(0,y.jsxs)(`div`,{style:{fontFamily:`'Orbitron',monospace`,fontSize:20,fontWeight:900,color:`#fff`,letterSpacing:2},children:[p,` `,cl[f-1]]}),(0,y.jsx)(`div`,{style:{fontSize:10,letterSpacing:4,textTransform:`uppercase`,color:`#ffd700`,marginTop:2,minHeight:16,transition:`opacity 0.4s`,opacity:h?1:.3},children:h?h.name:`—`})]}),(0,y.jsxs)(`div`,{style:{fontFamily:`'Orbitron',monospace`,fontSize:12,color:`#5a7fa0`,textAlign:`right`,lineHeight:`1.6`},children:[`DEKLİNASYON`,(0,y.jsx)(`br`,{}),(0,y.jsxs)(`span`,{style:{fontSize:18,color:T,fontWeight:700},children:[g,m.toFixed(1),`°`]})]})]}),(0,y.jsxs)(`div`,{style:{position:`fixed`,right:24,top:`50%`,transform:`translateY(-50%)`,zIndex:20,display:`flex`,flexDirection:`column`,gap:10,background:`rgba(4,12,24,0.88)`,border:`1px solid rgba(80,160,255,0.25)`,borderRadius:12,padding:`16px 18px`,backdropFilter:`blur(8px)`},children:[(0,y.jsx)(`div`,{style:{fontFamily:`'Orbitron',monospace`,fontSize:9,letterSpacing:3,color:`#5a7fa0`,textTransform:`uppercase`,textAlign:`center`,marginBottom:4},children:`Paraleller`}),[{color:`#ff3344`,label:`Yengeç Dönencesi (23.5°K)`},{color:`#ffe066`,label:`Ekvator (0°)`},{color:`#44aaff`,label:`Oğlak Dönencesi (23.5°G)`}].map(({color:e,label:t})=>(0,y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:10,fontSize:11,whiteSpace:`nowrap`},children:[(0,y.jsx)(`div`,{style:{width:28,height:3,borderRadius:2,background:e,flexShrink:0}}),t]},t)),(0,y.jsx)(`hr`,{style:{border:`none`,borderTop:`1px solid rgba(80,160,255,0.2)`,margin:`4px 0`}}),(0,y.jsx)(`div`,{style:{fontSize:10,color:`#5a7fa0`,textAlign:`center`},children:`🖱 Sürükle → Döndür`})]}),(0,y.jsxs)(`div`,{style:{position:`fixed`,bottom:0,left:0,right:0,zIndex:20,padding:`18px 32px 22px`,background:`linear-gradient(0deg,rgba(2,4,8,0.97) 60%,rgba(2,4,8,0) 100%)`,borderTop:`1px solid rgba(80,160,255,0.2)`,backdropFilter:`blur(8px)`},children:[(0,y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:16,marginBottom:14},children:[(0,y.jsx)(`span`,{style:{fontFamily:`'Orbitron',monospace`,fontSize:10,letterSpacing:2,color:`#5a7fa0`,textTransform:`uppercase`,whiteSpace:`nowrap`},children:`Yıl Boyunca`}),(0,y.jsxs)(`div`,{style:{flex:1,position:`relative`},children:[(0,y.jsx)(`input`,{type:`range`,min:`0`,max:`364`,value:a,onChange:x,style:{width:`100%`,WebkitAppearance:`none`,appearance:`none`,height:4,borderRadius:2,outline:`none`,cursor:`pointer`,background:`linear-gradient(90deg,#ff3344 0%,#ffe066 25%,#44aaff 50%,#ffe066 75%,#ff3344 100%)`}}),(0,y.jsx)(`div`,{style:{display:`flex`,justifyContent:`space-between`,padding:`0 2px`,marginTop:6},children:ul.map((e,t)=>(0,y.jsx)(`span`,{onClick:()=>b(dl[t],!0),style:{fontSize:9,color:`#5a7fa0`,cursor:`pointer`,flex:1,textAlign:`center`,transition:`color 0.2s`},onMouseEnter:e=>e.target.style.color=`#fff`,onMouseLeave:e=>e.target.style.color=`#5a7fa0`,children:e},e))})]})]}),(0,y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:12,flexWrap:`wrap`},children:[(0,y.jsxs)(`div`,{style:{display:`flex`,alignItems:`center`,gap:8,background:`rgba(10,25,50,0.7)`,border:`1px solid rgba(80,160,255,0.25)`,borderRadius:8,padding:`8px 14px`},children:[(0,y.jsx)(`label`,{style:{fontSize:10,letterSpacing:2,color:`#5a7fa0`,textTransform:`uppercase`,whiteSpace:`nowrap`},children:`Tarih`}),(0,y.jsx)(`input`,{type:`date`,value:`2026-${String(f).padStart(2,`0`)}-${String(p).padStart(2,`0`)}`,onChange:S,style:{background:`transparent`,border:`none`,outline:`none`,color:`#fff`,fontFamily:`'Exo 2',sans-serif`,fontSize:14,cursor:`pointer`,colorScheme:`dark`}})]}),(0,y.jsx)(`button`,{onClick:C,style:Sl,children:`📅 Bugüne Git`}),(0,y.jsx)(`button`,{onClick:w,style:{...Sl,background:s?`rgba(68,170,255,0.22)`:`rgba(68,170,255,0.1)`,boxShadow:s?`0 0 16px rgba(68,170,255,0.3)`:`none`},children:s?`⏸ Durdur`:`▶ Oto Oynat`}),(0,y.jsx)(`div`,{style:{display:`flex`,gap:6,marginLeft:`auto`},children:[{doy:79,label:`İlkbahar Ekinoksu`,icon:`🌿`},{doy:171,label:`Yaz Gündönümü`,icon:`☀️`},{doy:265,label:`Sonbahar Ekinoksu`,icon:`🍂`},{doy:354,label:`Kış Gündönümü`,icon:`❄️`}].map(({doy:e,label:t,icon:n})=>(0,y.jsx)(`button`,{onClick:()=>{c(!1),b(e,!0)},title:t,style:{...Sl,padding:`8px 12px`,fontSize:16},children:n},e))})]})]}),(0,y.jsx)(`style`,{children:`
      ...
      `})]})}var Sl={fontFamily:`'Orbitron',monospace`,fontSize:10,letterSpacing:2,textTransform:`uppercase`,padding:`10px 18px`,borderRadius:8,border:`1px solid #44aaff`,background:`rgba(68,170,255,0.1)`,color:`#44aaff`,cursor:`pointer`,transition:`all 0.2s`,whiteSpace:`nowrap`};function Cl(){let[e,t]=(0,_.useState)(!1);return(0,y.jsx)(y.Fragment,{children:e?(0,y.jsx)(xl,{}):(0,y.jsx)(b,{onStart:()=>t(!0)})})}(0,g.createRoot)(document.getElementById(`root`)).render((0,y.jsx)(_.StrictMode,{children:(0,y.jsx)(Cl,{})}));